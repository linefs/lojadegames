...
import com.generation.mygamestore.model.Categoria;
...
public class CategoriaController {
	...
	public class TemaController {
	    ...
	    public ResponseEntity<List<Categoria>> getByName(@PathVariable 
	    String nome){
	    ...
	    @PostMapping
	    public ResponseEntity<Categoria> post(@Valid @RequestBody Categoria categ){
	        return ResponseEntity.status(HttpStatus.CREATED)
	                .body(categoriaRepository.save(categ));
	    }
